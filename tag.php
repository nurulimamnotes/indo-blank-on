...
<link rel="stylesheet" type="text/css" media="all" href="<?php echo get_template_directory_uri(); ?>/css/tags.css" />
<link rel="shortcut icon" type="image/x-icon" href="<?php echo get_template_directory_uri(); ?>/images/favicon/kacamata.ico" />


</head>
<body>

<div style="margin-top:5px;border-bottom:solid 3px #000"></div>
	<ul id="menu">
...
<div style="clear:both;border-top:solid 3px #000"></div>

<header>
<h1><?php single_tag_title('Article under '); ?> tags</h1>
</header>
